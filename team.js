...
function showText(){
  if(tracker == 0){
    ...
    containTwo.append(`<h5>Wireframe</h5>`);
    containTwo.append(`<img class = "wirePic" src = "processTwo.jpg" />`);
    containTwo.append(`<img class = "wirePic"src = "processOne.jpg" />`);
    containTwo.append(`<img class = "wirePic" src = "processThree.jpg" />`);
  }else if (tracker == 1){
    tracker--;
    phoebeContain.empty();
